...
use strict ;
use warnings ;
eval { require Bio::Seq; require Bio::Tools::pICalculator; require Bio::Tools::SeqPattern; require Bio::SearchIO; require Bio::SeqIO; require Bio::SeqIO::fasta; Bio::Seq->import(); };
my $bioperl_available = $@ ? 0 : 1;
eval { require DBI; DBI->import(); };
my $dbi_available = $@ ? 0 : 1;
